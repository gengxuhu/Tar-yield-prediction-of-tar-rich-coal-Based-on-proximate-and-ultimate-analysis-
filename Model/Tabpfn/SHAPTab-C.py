...
# 将DataFrame写入Excel文件
with pd.ExcelWriter(r'D:\研究生学习\博士学习\论文3\数据集\模型参数\TabPFNc.xlsx') as writer:
...
# 添加标注并保存图形
ax_sw.text(0.02, 0.98, '(p)', transform=ax_sw.transAxes,
...
output_main_folder = r"D:\研究生学习\博士学习\论文3\绘图\shapTab\C"
