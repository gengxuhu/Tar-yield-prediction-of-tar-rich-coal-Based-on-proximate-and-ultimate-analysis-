...
config = {
    "font.family": 'serif',
    "font.size": 34,  # 相当于小四大小
    "mathtext.fontset": 'cm',  # 使用 Computer Modern，最接近 Times New Roman 的数学字体
    "mathtext.rm": 'Times New Roman',  # 数学文本使用 Times New Roman
    "mathtext.it": 'Times New Roman:italic',  # 数学斜体
    "mathtext.bf": 'Times New Roman:bold',  # 数学粗体
...
# 将DataFrame写入Excel文件
with pd.ExcelWriter(r'D:\研究生学习\博士学习\论文3\数据集\模型参数\TabPFNb.xlsx') as writer:
...
# 添加标注并保存图形
ax_sw.text(0.02, 0.98, '(o)', transform=ax_sw.transAxes,
...
output_main_folder = r"D:\研究生学习\博士学习\论文3\绘图\shapTab\B"
